...
export const api = {
  ...
  // Escrow
  createEscrow: (data: { consumerId: string; businessId: string; paymentRequestCode?: string; productId?: string; totalAmount: number; months?: number; escrowType?: EscrowType; unitPrice?: number; validityMonths?: number; validFrom?: string; validUntil?: string }) =>
